...
dates, the syllabus, and student grades will be made available via bCourses or a
public website. There will be an anonymous mid-semester feedback survey; the
link will be sent to students' \texttt{berkeley.edu} email addresses. This
survey will be provided through SurveyMonkey or a similar service. \\
...
Mid-semester Feedback Survey \dotfill Thursday, Mar.~22\\
...
\begin{itemize} \itemsep-0.4em
  \vspace{1mm}
  \item \textit{Topics:} Asymptotic linearity, influence curves, and inference
