...
\begin{itemize} \itemsep-0.4em
  ...
  \item \textit{Before:} Read Ch.4--6 and A.~6 of vdL\&R (2011); watch Week 12
    video lectures
  \item \textit{Lab:} Computation of Targeted Maximum Likelihood Estimators and
    introduction to the \texttt{tmle3} R package
  \vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
  ...
  \item \textit{Lab:} \textit{Special Topics:} Variable Importance, CV-TMLE,
    TMLEs with Doubly Robust Inference
  \vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
